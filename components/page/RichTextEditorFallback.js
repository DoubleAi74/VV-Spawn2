export const RICH_TEXT_EDITOR_FRAME_HEIGHT_CLASS = "min-h-[110px]";

export default function RichTextEditorFallback() {
  return (
    <div
      className={`overflow-hidden rounded-[3px] border border-white/10 bg-neutral/5 ${RICH_TEXT_EDITOR_FRAME_HEIGHT_CLASS}`}
    >
      ...
      <div className="min-h-[74px] bg-white/[0.02] px-4 py-3">
