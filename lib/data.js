...
export async function updateUserDashboard(
  ...
  return User.findByIdAndUpdate(
    ...
    {
      $set: {
        'dashboard.infoText': stored,
        'dashboard.infoMode': mode,
        'dashboard.infoText1': stored1,
        'dashboard.infoMode1': mode1,
      },
    },
    { new: true }
  ).lean();
...
export async function updatePageMeta(
  ...
  return Page.findByIdAndUpdate(
    ...
    {
      $set: {
        'pageMetaData.infoText1': stored1,
        'pageMetaData.infoText2': stored2,
        'pageMetaData.infoMode': mode,
        'pageMetaData.infoMode1': mode1,
      },
    },
    { new: true }
  ).lean();
