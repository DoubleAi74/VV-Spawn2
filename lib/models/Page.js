...
const PageSchema = new mongoose.Schema({
  ...
  // When false, visitors (non-owners) do not see the post Download control.
  // Owners always see it. Defaults true so existing pages stay downloadable.
  isDownloadable: {
    type: Boolean,
    default: true,
  },
  ...
  pageMetaData: {
    gridCols: {
      type: Number, default: null, min: 1, max: 8,
