...
/** Same default the theme provider uses when a profile has no dashHex. */
export const DEFAULT_THEME_COLOR = '#2d3e50';
 ...
 * invited to try.
 */
/** Next 15 reads theme-color from the viewport export, not metadata. */
export function buildViewport({ themeColor } = {}) {
  return {
    themeColor: normalizeHex(themeColor, DEFAULT_THEME_COLOR),
  };
}
